    ...
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        onPressed: () async {
          ...
          try {
            await BoxService.sendBoxRequest(
            ...
            if (context.mounted) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Box request sent successfully! 🎁')),
              );
              // Pop ReviewBoxScreen and SendBoxScreen back to nearby users list
              Navigator.pop(context, true); // Pop ReviewBoxScreen with success
              Navigator.pop(context, true); // Pop SendBoxScreen with success
            }
          } catch (e) {
            if (context.mounted) {
              Navigator.pop(context); // Pop loading dialog
